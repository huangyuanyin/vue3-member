  ...
  <div class="summary" flex>
          ...
          <Card>
            ...
            <template slot="content">
              ...
              <div>
                <chart
                  ref="chart1"
                  :options="returnBar(classifyStatistic.chartData)"
          ...
          <Card>
            ...
            <template slot="content">
              <div class="table">
                ...
                <div
                  class="table-row"
                  v-for="(item, index) in classifyStatistic.deptList"
                  :key="index"
                  flex="main:justify"
                >
                  <span>{{ item.name }}</span>
    ...
    >
        ...
        <div class="outer-wrapper">
          <div class="tip-wrapper" flex="space:around">
            <div class="tip-item">
              <div class="tip-item-inner" flex="space:around cross:center">
                ...
                <span class="tip-item-font">
                  <i>资源信息数量</i><br />
                  <i class="num">{{ summaryCounts.resource }}</i
                  ><i>（条）</i>
                </span>
              </div>
            ...
            <div class="tip-item">
              <div class="tip-item-inner" flex="space:around cross:center">
                ...
                <span class="tip-item-font">
                  <i>数据归集数量</i><br />
                  <i class="num">{{ summaryCounts.collection }}</i
                  ><i>（条）</i>
                </span>
              </div>
              <span class="light-corner"></span>
            ...
            <div class="tip-item">
              <div class="tip-item-inner" flex="space:around cross:center">
                ...
                <span class="tip-item-font">
                  <i>资源信息数量</i><br />
                  <i class="num">{{ summaryCounts.month }}</i
                  ><i>（条）</i>
                </span>
              </div>
              <span class="light-corner"></span>
          ...
          <div class="float-tip-wrapper float-1" flex="main:justify">
            <span class="float-tip-wrapper-item" flex="dir:top cross:center">
              ...
              <span
                ><i class="num">{{ summaryCounts.naturalPerson }}</i
                ><i>（条）</i></span
              >
            </span>
            <span class="float-tip-wrapper-item" flex="dir:top cross:center">
              ...
              <span
                ><i class="num">{{ summaryCounts.legalPerson }}</i
                ><i>（条）</i></span
              >
            </span>
          </div>
          <div class="float-tip-wrapper float-2" flex="main:justify">
            <span class="float-tip-wrapper-item" flex="dir:top cross:center">
              ...
              <span
                ><i class="num">{{ summaryCounts.focusPerson }}</i
                ><i>（条）</i></span
              >
            </span>
            <span class="float-tip-wrapper-item" flex="dir:top cross:center">
              ...
              <span><i>严重通过率</i></span>
              <span
                ><i class="num">{{ summaryCounts.passPercent }}%</i
                ><i>（条）</i></span
              >
            </span>
          </div>
          <div
            id="cvsBg"
            style="margin-top: 12px;width: 100%; height: 500px;"
          ></div>
      ...
      <template slot="inner">
        <chart
          ref="chart2"
          :options="returnTrend(summaryCounts.chartList)"
          ...
          <Card>
            <template slot="title">
              <div flex="main:justify">
                ...
                <span class="handle-date" flex="main:justify">
                  <i class="tab active" v-show="tab === 0" @click="tab = 1"
                    ><i
                    ...
                    >法人</i
                  >
                  <i class="tab active" v-show="tab === 1" @click="tab = 0"
                    ><i
                      class="iconfont icon-ios-repeat"
                      style="color: #00cbfe; font-size: 18px; vertical-align: top"
                    ></i
            ...
            <template slot="content">
              <chart
                ref="chart4"
                :options="returnPie(naturalPersonAnalysis)"
                style="width: 100%; height: 280px;"
              ></chart>
            </template>
          </Card>
          <Card>
            ...
            <template slot="content">
              <div class="table">
                ...
                <div
                  class="table-row"
                  v-for="(item, index) in newestFillInDept"
                  :key="index"
                  flex="main:justify"
                >
                  <span>{{ item.name }}</span>
