        ...
        <div style="height: 100%" flex="main:justify dir:top">
          ...
          <div class="count-wrapper">
            <span class="square-bg">
              <i class="count-title">奖惩数量</i><br />
              <i class="num">{{ union.memoCount }}</i
              ><i class="white-font">（条）</i>
            </span>
            <span class="square-bg">
              <i class="count-title">措施数量</i><br />
              <i class="num">{{ union.measureCount }}</i
              ><i class="white-font">（条）</i>
            </span>
            <span class="square-bg">
              <i class="count-title">实施部门数量</i><br />
              <i class="num">{{ union.deptCount }}</i
          ...
          <div class="title" flex="main:justify">
            ...
            <span class="handle-btn" flex>
              <i
                class="btn"
                :class="handleBtnTab1 === 0 ? 'active' : ''"
                @click="changeExchangeDataMonth"
                >本月</i
              >
              <i
                class="btn"
                :class="handleBtnTab1 === 1 ? 'active' : ''"
                @click="changeExchangeDataYear"
                >本年</i
              >
              <b-date-picker
                type="daterange"
              ...
              >
                <a
                  style="display: block; width: 76px"
                  href="javascript:void(0)"
                  @click="handleClick('dateOpen1')"
                >
          ...
          <div class="count-wrapper nowrap" style="padding: 0 8px 20px">
            <span class="square-bg data-change">
              ...
              <i>交换数据总量</i><br />
              <i class="num">{{ dataExchange.getIn + dataExchange.getOut }}</i
              ><i>（条）</i>
            </span>
            <span class="square-bg data-change" flex>
              <span>
                <i class="num">{{ dataExchange.getIn }}</i
                ><i>（条）</i><br />
                <i>归集数据量</i><br />
                <i style="line-height: 40px">正确率</i
                ><i style="color: #00ccff; line-height: 40px"
                  >&nbsp;{{ dataExchange.getInCorrect }}</i
                ><br />
              </span>
              <span>
                <i class="num">{{ dataExchange.getOut }}</i
                ><i>（条）</i><br />
                <i>输出数据量</i><br />
                <i style="line-height: 40px">正确率</i
                ><i style="color: #00ccff; line-height: 40px"
                  >&nbsp;{{ dataExchange.getOutCorrect }}</i
                ><br />
              </span>
            </span>
            ...
            <span class="square-bg data-change mt-5">
              <span style="padding-bottom: 0; padding-top: 0">
                <i>任务监控</i><br />
                <i style="line-height: 40px">正常任务</i>&nbsp;<i class="num">{{
                  dataExchange.dockedNormal
                }}</i
                >&nbsp;<i style="line-height: 40px">异常</i>&nbsp;<i
                  class="num"
                  >{{ dataExchange.dockedAbnormal }}</i
                >
              </span>
            </span>
          </div>
          ...
          <div class="rotate">
            <div class="rotate-inner">
              <div class="inner-item">
                <p>
                  <i>{{ rotateData[0].name }}</i>
                </p>
                <p>
                  <i class="num">{{ rotateData[0].value }}</i
                  ><i>(条)</i>
                </p>
                <div>
              ...
              <div class="inner-item">
                <p>
                  <i>{{ rotateData[1].name }}</i>
                </p>
                <p>
                  <i class="num">{{ rotateData[1].value }}</i
                  ><i>(条)</i>
                </p>
                <div>
                  <img src="~@/assets/images/overview/data.png" alt="" />
              ...
              <div class="inner-item">
                <p>
                  <i>{{ rotateData[2].name }}</i>
                </p>
                <p>
                  <i class="num">{{ rotateData[2].value }}</i
                  ><i>(条)</i>
                </p>
                <div>
                  <img src="~@/assets/images/overview/data.png" alt="" />
              ...
              <div class="inner-item">
                <p>
                  <i>{{ rotateData[3].name }}</i>
                </p>
                <p>
                  <i class="num">{{ rotateData[3].value }}</i
                  ><i>(条)</i>
                </p>
                <div>
                  <img src="~@/assets/images/overview/data.png" alt="" />
              ...
              <div class="inner-item">
                <p>
                  <i>{{ rotateData[4].name }}</i>
                </p>
                <p>
                  <i class="num">{{ rotateData[4].value }}</i
                  ><i>(条)</i>
                </p>
                <div>
                  <img src="~@/assets/images/overview/data.png" alt="" />
              ...
              <div class="inner-item">
                <p>
                  <i>{{ rotateData[5].name }}</i>
                </p>
                <p>
                  <i class="num">{{ rotateData[5].value }}</i
                  ><i>(条)</i>
                </p>
                <div>
                  <img src="~@/assets/images/overview/data.png" alt="" />
            ...
            <div class="msg-list" flex="wrap:wrap">
              <div class="msg-list-item" flex="main:center">
                ...
                <span>
                  ...
                  <p>
                    <i class="num">{{ redBlackList.redList.signCom }}</i
                    ><i class="white-font">（个）</i>
                  </p>
                </span>
              </div>
              <div class="msg-list-item" flex="main:center">
                <img
                  class="rb-icon"
                  src="~@/assets/images/overview/icon_ajnsr.png"
                  alt=""
                />
                <span>
                  <p class="white-font">A级纳税人</p>
                  <p>
                    <i class="num">{{ redBlackList.redList.taxpayer }}</i
                    ><i class="white-font">（个）</i>
                  </p>
                </span>
              </div>
              <div class="msg-list-item" flex="main:center">
                <img
                  class="rb-icon"
                  src="~@/assets/images/overview/icon_shfr.png"
                  alt=""
                />
                <span>
                  <p class="white-font">社会法人诚实守信</p>
                  <p>
                    <i class="num">{{ redBlackList.redList.corp }}</i
                    ><i class="white-font">（个）</i>
                  </p>
                </span>
              </div>
              <div class="msg-list-item" flex="main:center">
                <img
                  class="rb-icon"
                  src="~@/assets/images/overview/icon_zyz.png"
                  alt=""
                />
                <span>
                  <p class="white-font">优秀青年志愿者</p>
                  <p>
                    <i class="num">{{ redBlackList.redList.volunteer }}</i
                    ><i class="white-font">（个）</i>
                  </p>
                </span>
              </div>
            ...
            <div class="msg-list" flex="wrap:wrap">
              <div class="msg-list-item" flex="main:center">
                ...
                <span>
                  ...
                  <p>
                    <i class="num">{{ redBlackList.blackList.performed }}</i
                    ><i class="white-font">（个）</i>
                  </p>
                </span>
              </div>
              <div class="msg-list-item" flex="main:center">
                ...
                <span>
                  ...
                  <p>
                    <i class="num">{{ redBlackList.blackList.case }}</i
                    ><i class="white-font">（个）</i>
                  </p>
                </span>
              </div>
              <div class="msg-list-item" flex="main:center">
                ...
                <span>
                  ...
                  <p>
                    <i class="num">{{ redBlackList.blackList.unpaid }}</i
                    ><i class="white-font">（个）</i>
                  </p>
                </span>
              </div>
              <div class="msg-list-item" flex="main:center">
                ...
                <span>
                  ...
                  <p>
                    <i class="num">{{ redBlackList.blackList.lose }}</i
                    ><i class="white-font">（个）</i>
                  </p>
                </span>
              </div>
        ...
        <div style="height: 100%" flex="main:justify dir:top">
          ...
          <div class="title" style="margin-top: 10px" flex="main:justify">
            ...
            <span class="handle-btn" flex>
              <i
                class="btn"
                :class="handleBtnTab2 === 0 ? 'active' : ''"
                @click="changeReportDataMonth"
                >本月</i
              >
              <i
                class="btn"
                :class="handleBtnTab2 === 1 ? 'active' : ''"
                @click="changeReportDataYear"
                >本年</i
              >
              <b-date-picker
                type="daterange"
          ...
          <div class="chart-msg-bar">
            信用报告查询总次数：{{ reSum(report.chartData, 1) }}（次）
          </div>
          <chart
            ref="chart2"
